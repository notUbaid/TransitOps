  ...
  return (
    <div className="flex h-full flex-col bg-white px-4 py-6">
      ...
      <div className="mt-4 space-y-3 border-t border-outline-variant pt-4">
        ...
        <button
          onClick={logout}
          className="flex w-full items-center gap-3 rounded-xl px-4 py-2.5 text-on-surface-variant transition-all duration-200 hover:bg-error/10 hover:text-error"
        >
